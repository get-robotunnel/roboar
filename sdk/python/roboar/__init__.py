...
Platform API (managed platforms with human owners):
    PlatformAgent  — platform-side agent: register, capability CRUD, heartbeat
...
__all__ = ["Agent", "Capability", "AgentClient", "PlatformAgent", "RegistryClient"]
__version__ = "0.3.0"
